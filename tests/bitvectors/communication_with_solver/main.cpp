...
{
    TEST_MESSAGE("Starting: test_is_satisfiable()");
...
{
    TEST_MESSAGE("Starting: test_get_model_if_satisfiable()");
...
{
    TEST_MESSAGE("Starting: test_nonlinear_terms()");
...
static void communication_with_solver()
{
    test_is_satisfiable();
...
TEST_DEFINE_MAIN_FUNCTION_CALLING(communication_with_solver)
